...
static ssize_t (*klpe_tap_get_user)(struct tap_queue *q, void *msg_control,
		       ...
		       size_t total_len)
{
	...
	return (*klpe_tap_get_user)(q, ctl ? ctl->ptr : NULL, &m->msg_iter,
...
#define LP_MODULE "tap"

static struct klp_kallsyms_reloc klp_funcs[] = {
	{ "tap_get_user", (void *)&klpe_tap_get_user, "tap" },
};

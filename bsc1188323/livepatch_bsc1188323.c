...
static int (*klpe_bcm_tx_setup)(struct bcm_msg_head *msg_head, struct msghdr *msg,
			int ifindex, struct sock *sk);

static int (*klpe_bcm_rx_setup)(struct bcm_msg_head *msg_head, struct msghdr *msg,
			int ifindex, struct sock *sk);
...
int klpp_bcm_sendmsg(struct socket *sock, struct msghdr *msg, size_t size)
{
	...
	case TX_SETUP:
		ret = (*klpe_bcm_tx_setup)(&msg_head, msg, ifindex, sk);
		break;

	case RX_SETUP:
		ret = (*klpe_bcm_rx_setup)(&msg_head, msg, ifindex, sk);
		break;
...
static struct klp_kallsyms_reloc klp_funcs[] = {
	...
	{ "bcm_tx_setup", (void *)&klpe_bcm_tx_setup, "can_bcm" },
	{ "bcm_read_op", (void *)&klpe_bcm_read_op, "can_bcm" },
	{ "bcm_rx_setup", (void *)&klpe_bcm_rx_setup, "can_bcm" },
};

/*
 * livepatch_bsc1225011
 *
 * Fix for CVE-2024-35863, bsc#1225011
 *
 *  Upstream commit:
 *  69ccf040acdd ("smb: client: fix potential UAF in is_valid_oplock_break()")
 *
 *  SLE12-SP5 commit:
 *  be79366494b04862b0ce42ebd90151720186dee3
 *
 *  SLE15-SP2 and -SP3 commit:
 *  Not affected
 *
 *  SLE15-SP4 and -SP5 commit:
 *  bfa9e6b4d4b238078e6afc0e702765aa038ac5db
 *
 *  SLE15-SP6 commit:
 *  06c348c41c346ef454f0f94f5da72c5d72bf2df2
 *
...
/* klp-ccp: from fs/cifs/dns_resolve.h */
#include <linux/net.h>
...
#include "livepatch_bsc1225011.h"
...
bool
klpp_is_valid_oplock_break(char *buffer, struct TCP_Server_Info *srv)
{
	...
	list_for_each(tmp, &srv->smb_ses_list) {
		...
		list_for_each(tmp1, &ses->tcon_list) {
			...
			list_for_each(tmp2, &tcon->openFileList) {
				...
				(*klpe_cifs_queue_oplock_break)(netfile);

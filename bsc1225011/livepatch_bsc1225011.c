...
/* klp-ccp: from fs/smb/client/misc.c */
...
extern void klpe_cifs_queue_oplock_break(struct cifsFileInfo *cfile) \
...
#define VFS 1
#define FYI 2
extern int klpe_cifsFYI KLP_RELOC_SYMBOL(cifs, cifs, cifsFYI);
#ifdef CONFIG_CIFS_DEBUG2
#define NOISY 4
#else
#define NOISY 0

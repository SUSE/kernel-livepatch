...
extern void authenc_esn_verify_ahash_done(void *data, int err);
...
extern typeof(authenc_esn_verify_ahash_done) authenc_esn_verify_ahash_done
	 KLP_RELOC_SYMBOL(authencesn, authencesn, authenc_esn_verify_ahash_done);

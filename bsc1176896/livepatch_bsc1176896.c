 ...
 *  7ba9dcbe80f98cc2026934b85ab14f47ac775f91
 *
 *  SLE12-SP4, SLE12-SP5, SLE15 and SLE15-SP1 commit:
 *  835f6ff71362dd9cd87799b09c88b113bf60530f
 *
 *  SLE15-SP2 commit:
 *  8cc06a9b246ce0512b796617bee999ee14f8bf12
 *
 *
...
static bool (*klpe_hidinput_setup_battery)(struct hid_device *dev, unsigned report_type, struct hid_field *field);
#define klpr_hidinput_setup_battery (*klpe_hidinput_setup_battery)

#else  /* !CONFIG_HID_BATTERY_STRENGTH */

static bool klpr_hidinput_setup_battery(struct hid_device *dev, unsigned report_type,
				     ...
				     struct hid_usage *usage)
{
	...
	case HID_UP_GENDEVCTRLS:
		if (klpr_hidinput_setup_battery(device, HID_INPUT_REPORT, field))
			goto ignore;
		else
			goto unknown;
		break;

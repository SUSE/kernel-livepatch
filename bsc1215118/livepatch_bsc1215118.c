/*
 * livepatch_bsc1215118
 *
 * Fix for CVE-2023-4147, bsc#1215118
 *
 *  Upstream commit:
 *  0ebc1064e487 ("netfilter: nf_tables: disallow rule addition to bound chain via NFTA_RULE_CHAIN_ID")
 *
 *  SLE12-SP5, SLE15-SP1 and SLE15-SP2 commit:
 *  Not affected
 *
 *  SLE15-SP3 commit:
 *  1258138c48173aeb05857a165d189ffe371a0f9d
 *
			     ...
			     const struct nlattr * const nla[])
{
	...
	if (nla[NFTA_RULE_CHAIN]) {
		...
		chain = (*klpe_nft_chain_lookup_byid)(net, table, nla[NFTA_RULE_CHAIN_ID],
					      genmask);
		if (IS_ERR(chain)) {
...
#include "livepatch_bsc1215118.h"

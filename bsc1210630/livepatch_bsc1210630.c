...
static int klp_resolve_last_used_port(void)
{
	...
	if(!strcmp(UTS_RELEASE, "5.14.21-150400.15.5-rt")) { /* 15.4rtu1 */
		klp_funcs[0].symname = "last_used_port.91408";
	} else if(!strcmp(UTS_RELEASE, "5.14.21-150400.15.8-rt")) { /* 15.4rtu2 */
		klp_funcs[0].symname = "last_used_port.91418";
	} else if(!strcmp(UTS_RELEASE, "5.14.21-150400.15.11-rt")) { /* 15.4rtu3 */
		klp_funcs[0].symname = "last_used_port.91436";
	} else if(!strcmp(UTS_RELEASE, "5.14.21-150400.15.18-rt")) { /* 15.4rtu5 */
		klp_funcs[0].symname = "last_used_port.91447";
	} else if(!strcmp(UTS_RELEASE, "5.14.21-150400.15.23-rt")) { /* 15.4rtu6 */
		klp_funcs[0].symname = "last_used_port.91488";
	} else if(!strcmp(UTS_RELEASE, "5.14.21-150500.11-rt")) { /* 15.5rtu0 */
		klp_funcs[0].symname = "last_used_port.90350";
	}

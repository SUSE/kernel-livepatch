 ...
 *
 * Fix for CVE-2020-0465, bsc#1180030 (hid-multitouch part)
 *
 *  Upstream commit:
...
static int livepatch_bsc1180030_module_notify(struct notifier_block *nb,
...
static struct notifier_block livepatch_bsc1180030_module_nb = {
	.notifier_call = livepatch_bsc1180030_module_notify,
	.priority = INT_MIN+1,
};
...
int livepatch_bsc1180030_init(void)
{
	...
	ret = register_module_notifier(&livepatch_bsc1180030_module_nb);
out:
...
{
	unregister_module_notifier(&livepatch_bsc1180030_module_nb);
}

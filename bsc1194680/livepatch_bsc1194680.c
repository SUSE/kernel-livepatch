/*
 * livepatch_bsc1194680
 *
 * Fix for CVE-2020-25670, CVE-2020-25671, CVE-2020-25672, CVE-2020-25673,
 * bsc#1194680 and CVE-2021-23134, bsc#1186061
 *
 *  Upstream commits:
 *  a0c2dc1fe63e ("nfc: fix memory leak in llcp_sock_bind()")
 *  c33b1cc62ac0 ("nfc: fix refcount leak in llcp_sock_bind()")
 *  8a4cd82d62b5 ("nfc: fix refcount leak in llcp_sock_connect()")
 *  7574fcdbdcb3 ("nfc: fix memory leak in llcp_sock_connect()")
 *  4b5db93e7f2a ("nfc: Avoid endless loops caused by repeated
 *                llcp_sock_connect()")
 *  c61760e6940d ("net/nfc: fix use-after-free llcp_sock_bind/connect")
 *
 *  SLE12-SP3 commits:
 *  7557dd11f9a1a2fcab98a110a961041cc9a17e3e
 *  444a158b2518f1fcffb9d61afa4abc7432cb0f11
 *  863398566c56d715206647e4e1d8d835c5062d2e
 *  f75c5719b369175faf013d2ca6e89194cbd611f9
 *  2b122d693af7245021bc9978431f81902c82a23e
 *  8490bfcab96e4864915b21b7e3895d5ef4d0b877
 *
 *  SLE12-SP4, SLE12-SP5, SLE15 and SLE15-SP1 commits:
 *  2e7d9732e6180bb28367f14abadbb2fd45f4e84a
 *  1f433c24c3339254d108770e9fe88a1854edb21c
 *  adfe7b4d068bc597d6773c57b477537e07bac831
 *  71faffc0d5925082f363081873ef72f88f89cb1c
 *  577df82f61d5932af0db56b44dc49858b350c7fc
 *
 *  SLE15-SP2 and -SP3 commits:
 *  21864ef181bf6462ae89b43b8dd6c588e92d6f9a
 *  9f8067ea64584086eee324cbacd900808b2de0d8
 *  95b59cb542b1a0891d9f2841efd8a8535669582a
 *  ee06cff72859e13e776b57564c2dc9cc208474b1
...
#include <linux/kernel.h>
#include <linux/module.h>
#include "livepatch_bsc1194680.h"
...
static int livepatch_bsc1194680_module_notify(struct notifier_block *nb,
...
static struct notifier_block livepatch_bsc1194680_module_nb = {
	.notifier_call = livepatch_bsc1194680_module_notify,
	.priority = INT_MIN+1,
};
...
int livepatch_bsc1194680_init(void)
{
	...
	ret = register_module_notifier(&livepatch_bsc1194680_module_nb);
out:
...
{
	unregister_module_notifier(&livepatch_bsc1194680_module_nb);
}

...
/*trace definition*/
#include "klp_trace.h"
KLPR_TRACE_EVENT(ib_umad, ib_umad_write,
			     ...
			     size_t count, loff_t *pos)
{
	...
	klpr_trace_ib_umad_write(file, &packet->mad.hdr,
...
extern typeof(ib_create_send_mad) ib_create_send_mad
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_create_send_mad);
extern typeof(ib_free_send_mad) ib_free_send_mad
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_free_send_mad);
extern typeof(ib_get_mad_data_offset) ib_get_mad_data_offset
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_get_mad_data_offset);
extern typeof(ib_get_rmpp_segment) ib_get_rmpp_segment
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_get_rmpp_segment);
extern typeof(ib_is_mad_class_rmpp) ib_is_mad_class_rmpp
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_is_mad_class_rmpp);
extern typeof(ib_mad_kernel_rmpp_agent) ib_mad_kernel_rmpp_agent
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_mad_kernel_rmpp_agent);
extern typeof(ib_post_send_mad) ib_post_send_mad
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_post_send_mad);
extern typeof(ib_response_mad) ib_response_mad
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, ib_response_mad);
extern typeof(rdma_create_user_ah) rdma_create_user_ah
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, rdma_create_user_ah);
extern typeof(rdma_destroy_ah_user) rdma_destroy_ah_user
	 KLP_RELOC_SYMBOL(ib_umad, ib_core, rdma_destroy_ah_user);

...
static void (*klpe_cfg80211_send_layer2_update)(struct net_device *dev, const u8 *addr);
				    ...
				    struct station_parameters *params)
{
	...
	if (params->vlan && params->vlan != sta->sdata->dev) {
		...
		if (test_sta_flag(sta, WLAN_STA_AUTHORIZED)) {
			...
			(*klpe_cfg80211_send_layer2_update)(sta->sdata->dev,
						    sta->sta.addr);
		}
	}
...
static struct klp_kallsyms_reloc klp_funcs[] = {
	...
	{ "cfg80211_send_layer2_update",
	  (void *)&klpe_cfg80211_send_layer2_update, "cfg80211" },
};

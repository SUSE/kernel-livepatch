/*
 * livepatch_bsc1245793
 *
 * Fix for CVE-2025-37797, bsc#1245793
 *
...
extern const struct nla_policy hfsc_policy[TCA_HFSC_MAX + 1];
...
#include "livepatch_bsc1245793.h"

#include <linux/livepatch.h>

extern typeof(cftree_insert) cftree_insert
	 KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, cftree_insert);
extern typeof(hfsc_policy) hfsc_policy
	 KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, hfsc_policy);
extern typeof(init_ed) init_ed KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, init_ed);
extern typeof(qdisc_peek_len) qdisc_peek_len
	 KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, qdisc_peek_len);
...
extern typeof(sc2isc) sc2isc KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, sc2isc);
extern typeof(update_ed) update_ed
	 KLP_RELOC_SYMBOL(sch_hfsc, sch_hfsc, update_ed);
